...
class RecommendedCandidatesView(APIView):
    ...
    def get(self, request, vacancy_slug):
        ...
        for candidate in candidates:
                ...
                for edu in candidate_education:
                    for req_edu in required_education:
                        if req_edu in edu or edu in req_edu:
                            score += 20
                            reasons.append(f"Education matches requirements")
                            break
            ...
            if score > 0:
                # Check if already applied or offered
                ...
                recommendations.append({
                    ...
                    'profile_picture_url': request.build_absolute_uri(candidate.profile_picture.url) if candidate.profile_picture else None,
