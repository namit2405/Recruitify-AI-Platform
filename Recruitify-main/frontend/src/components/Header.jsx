        ...
        <div className="flex h-16 items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-8">
            ...
            >
              ...
              <span className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">Recruitify</span>
            </div>
          ...
          <div className="flex items-center gap-3">
              ...
              <div ref={searchRef} className="hidden md:block relative">
                <form onSubmit={handleSearch}>
                  ...
                  <Input
                    ...
                    className="pl-9 w-80 h-9 bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-800 focus:bg-white dark:focus:bg-gray-800 text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400"
                  />
                </form>
            ...
            {!isAuthenticated ? (
              <div className="hidden md:flex items-center gap-2">
                ...
                <Button
                  onClick={() => navigate({ to: isOrganization ? '/organization/post-vacancy' : '/register' })}
