                    ...
                    <div className="space-y-6">
                      {candidate.experience.map((exp, i) => (
                        <div key={i} className="flex gap-4">
                          <div className="w-12 h-12 rounded bg-gray-900 dark:bg-gray-700 flex items-center justify-center flex-shrink-0">
                  ...
                  <CardContent className="pt-6">
                    ...
                    <div className="space-y-6">
                      {candidate.education.map((edu, i) => (
                        <div key={i} className="flex gap-4">
                          <div className="w-12 h-12 rounded bg-blue-100 dark:bg-blue-900 flex items-center justify-center flex-shrink-0">
                  ...
                  <CardContent className="pt-6">
                    ...
                    <div className="space-y-3">
                      {candidate.accomplishments.map((acc, i) => (
                        <div key={i} className="flex items-start gap-3 p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg border border-blue-100 dark:border-blue-800">
