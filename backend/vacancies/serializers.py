...
class ApplicationSerializer(serializers.ModelSerializer):
    ...
    vacancy_slug = serializers.CharField(
        source='vacancy.slug',
        read_only=True
    )
...
class JobOfferSerializer(serializers.ModelSerializer):
    ...
    vacancy_slug = serializers.CharField(source='vacancy.slug', read_only=True)
    ...
    class Meta:
        ...
        read_only_fields = ('id', 'slug', 'organization', 'created_at', 'updated_at', 'responded_at')
