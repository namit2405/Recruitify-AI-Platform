...
class NotificationBulkDeleteView(APIView):
    ...
    Send { "ids": [1, 2, 3] } or { "ids": "all" } to delete all.
    """
    permission_classes = [permissions.IsAuthenticated]
    ...
    def delete(self, request):
        ...
        if ids == 'all':
            ...
            return Response({'detail': 'Provide ids list or "all"'}, status=400)
        return Response({'detail': f'{deleted} notification(s) deleted', 'deleted_count': deleted})
