    ...
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900">
      ...
      <main className="flex-1 py-8">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <Card className="mb-6 overflow-hidden border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
            ...
            <div className="relative h-48 bg-gradient-to-r from-blue-600 to-cyan-600">
              {organization.cover_photo_url ? (
                <img
                  src={fixMediaUrl(organization.cover_photo_url)}
                  alt="Cover"
                  className="w-full h-full object-cover cursor-pointer hover:opacity-90 transition-opacity"
                  onClick={() => setLightboxImage(fixMediaUrl(organization.cover_photo_url))}
                />
              ) : (
            ...
            <CardContent className="pt-0 px-6 pb-6">
              ...
              <div className="flex flex-col md:flex-row gap-6 -mt-16 relative">
                ...
                <div 
                  ...
                  onClick={() => organization.profile_picture_url && setLightboxImage(fixMediaUrl(organization.profile_picture_url))}
                >
                  {organization.profile_picture_url ? (
                    <img
                      src={fixMediaUrl(organization.profile_picture_url)}
          ...
          {/* Open Positions — full width below the 3-col grid */}
                ...
                <>
                  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {vacancies.map((vacancy) => (
                      <div
                        key={vacancy.id}
                        className="p-4 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-blue-500 dark:hover:border-blue-500 hover:shadow-md transition-all bg-white dark:bg-gray-800 flex flex-col gap-3"
                      >
                        <div className="flex items-start justify-between gap-2">
                          <h3 className="font-semibold text-base text-gray-900 dark:text-white leading-tight">
                            {vacancy.title}
                          </h3>
                          <Badge variant="outline" className="text-xs whitespace-nowrap flex-shrink-0 text-gray-700 dark:text-gray-300">
                        ...
                        <div className="flex flex-wrap gap-2 text-xs text-gray-500 dark:text-gray-400">
                          <span className="flex items-center gap-1">
                            ...
                            {vacancy.experience_level || 'Full-time'}
                          </span>
                        ...
                        <Button
                          ...
                          size="sm"
                          variant="outline"
                          className="mt-auto border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white dark:border-blue-400 dark:text-blue-400 w-fit"
                        >
                          <Link to="/candidate/jobs">View Details</Link>
                        </Button>
                      </div>
                    ))}
                  </div>
                  {vacancies.length > 6 && (
                    <Button asChild variant="link" className="w-full text-blue-600 dark:text-blue-400 mt-4">
                      <Link to="/candidate/jobs">View All {vacancies.length} Job Openings →</Link>
                    </Button>
                  )}
                </>
              ) : (
          ...
          {organization.user_id && (
            <Card className="mt-6 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
              <CardContent className="pt-6">
                ...
                <UserPostsFeed userId={organization.user_id} />
              </CardContent>
            </Card>
          )}
        </div>
