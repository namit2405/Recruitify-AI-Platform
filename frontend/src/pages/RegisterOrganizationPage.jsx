    ...
    return (
      <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-950">
        ...
        <main className="flex-1 flex items-center justify-center px-4 py-16">
          <Card className="max-w-md w-full bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 shadow-lg">
            <CardHeader className="text-center pb-2">
              <div className="flex justify-center mb-2">
                <img src="/images/Page, Features-dark.png" alt="Recruitify" className="hidden dark:block h-20 w-auto" />
                <img src="/images/Page-light.png" alt="Recruitify" className="block dark:hidden h-20 w-auto" />
              </div>
              <CardTitle className="text-2xl text-gray-900 dark:text-white">Register Your Organization</CardTitle>
