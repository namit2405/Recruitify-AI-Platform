...
export default function VacancyDetailPage() {
  const { slug } = useParams({ from: "/vacancy/$slug" });
        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="grid lg:grid-cols-3 gap-6 w-full items-start">
            ...
            <div className="lg:col-span-2 space-y-6 min-w-0">
              ...
              {/* Bottom row: Applications Overview + Additional Info side by side */}
              {isOwner && (
              ...
              {/* Additional Info for non-owners (no Applications Overview) */}
              {!isOwner && (
                <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 overflow-hidden">
                  <CardHeader>
                    <CardTitle className="text-gray-900 dark:text-white">Additional Information</CardTitle>
            ...
            <div className="space-y-6 min-w-0 lg:sticky lg:top-4 lg:self-start lg:max-h-[calc(100vh-6rem)] lg:overflow-y-auto lg:pr-1 scrollbar-thin">
